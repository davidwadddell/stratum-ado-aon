...
param secretcgSchemaName string
...
// #######################
module cgsSeceretVariables '../../../nf/bicep/designer/cgs-variables.bicep' = {
...
resource secretcgSchema 'Microsoft.Hybridnetwork/publishers/configurationGroupSchemas@2023-09-01' = {
  name: secretcgSchemaName
  parent: publisher
  location: location
  tags: {
  ...
  properties: {
    schemaDefinition: cgsSeceretVariables.outputs.outputSecretSchema
  }
}
