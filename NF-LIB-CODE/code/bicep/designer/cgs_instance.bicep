...
// #######################
module cgsInstanceVariables '../../../nf/bicep/designer/cgs-variables.bicep' = {
...
resource instancecgSchema 'Microsoft.Hybridnetwork/publishers/configurationGroupSchemas@2023-09-01' = {
  ...
  properties: {
    schemaDefinition: cgsInstanceVariables.outputs.outputInstanceSchema
  }
}
